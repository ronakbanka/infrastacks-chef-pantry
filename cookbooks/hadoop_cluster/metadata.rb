...
attribute "apt/cloudera/force_distro",
  ...
  :description           => "Typically, leave this blank. However if (as is the case in Nov 2011) you are on natty but Cloudera's repo only has packages up to precise, use this to override.",
  :default               => "precise"

attribute "apt/cloudera/release_name",
  :display_name          => "Release identifier (eg cdh4.4.0) of the cloudera repo to use. See also hadoop/deb_version",
  :description           => "Release identifier (eg cdh4.4.0) of the cloudera repo to use. See also hadoop/deb_version",
  :default               => "cdh4.4.0"
...
attribute "hadoop/deb_version",
  :display_name          => "Apt revision identifier (eg 0.20.2+923.142-1~precise-cdh3) of the specific cloudera apt to use. See also apt/release_name",
  :description           => "Apt revision identifier (eg 0.20.2+923.142-1~precise-cdh3) of the specific cloudera apt to use. See also apt/release_name",
  :default               => "2.0.0+1475-1.cdh4.4.0.p0.23~precise-cdh4.4.0"
